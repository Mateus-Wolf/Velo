...
export default function UserHistoryPage() {
    ...
    const filtered = useMemo(() => {
        ...
        return list;
    }, [appointments, filterStatus, filterWorkplace, dateFrom, dateTo, searchClient]);

    const hasActiveFilters = filterStatus !== 'all' || filterWorkplace || dateFrom || dateTo || searchClient.trim();
            ...
            <main className="relative z-10 mx-auto max-w-4xl px-4 py-8 sm:px-6">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="mb-6">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        {hasActiveFilters && (
                            <button
                                onClick={() => { setFilterStatus('all'); setFilterWorkplace(''); setDateFrom(''); setDateTo(''); setSearchClient(''); }}
